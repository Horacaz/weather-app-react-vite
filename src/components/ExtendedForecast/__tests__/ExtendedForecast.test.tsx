...
const extendedForecast: IParsedDailyForecast[] = [
    {
        ...
        "night": {
            "icon": "/weather-app-react-vite/src/assets/15.svg",
            "iconDescription": "Thunderstorms",
            "forecast": "Warm and humid with considerable clouds; a strong thunderstorm in spots late",
            "precipitation": 77,
            "wind": {
                "speed": 11.1,
                "direction": "NNE"
    ...
    },
    {
        ...
        "day": {
            "icon": "/weather-app-react-vite/src/assets/15.svg",
            "iconDescription": "Thunderstorms",
            "forecast": "Considerable cloudiness with a thunderstorm; very warm and humid",
            "precipitation": 91,
            "wind": {
                "speed": 13,
                "direction": "N"
        ...
        "night": {
            "icon": "/weather-app-react-vite/src/assets/15.svg",
            "iconDescription": "Thunderstorms",
            "forecast": "Warm with considerable cloudiness; a couple of evening thunderstorms followed by a shower late",
            "precipitation": 96,
            "wind": {
                "speed": 14.8,
                "direction": "N"
    ...
    },
    {
        ...
        "day": {
            ...
            "forecast": "More clouds than sun; warm with a couple of showers, mainly early in the day",
            "precipitation": 96,
            "wind": {
                "speed": 11.1,
                "direction": "WSW"
    ...
    },
    {
        ...
        "day": {
            ...
            "forecast": "A morning shower in places; otherwise, cooler with more clouds than sun",
            "precipitation": 43,
            "wind": {
                "speed": 20.4,
                "direction": "SE"
